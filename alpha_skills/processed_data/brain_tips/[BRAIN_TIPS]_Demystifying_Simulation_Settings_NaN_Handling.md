...
for example, suppose I simulate the expression "ts_mean(, d)"

- when inside window 'd', if all are nan, what does ts_mean return?
- when inside window 'd', some of are nan, what does ts_mean return?
